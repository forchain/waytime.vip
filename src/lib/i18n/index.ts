	...
	zh: {
		...
		services: {
			...
			customTours: {
				title: '私人定制旅行',
				description:
					'定制个性化的行程，将文化沉浸、风景探索与专属活动相结合，确保每次旅行都能反映客户的个人风格和兴趣。'
			},
			luxuryHotels: {
				title: '高端酒店预订',
				description:
					'确保在全球各地的豪华度假村和五星级酒店住宿，提供高级设施、独家优惠和无缝预订体验。'
			},
			premiumFlights: {
				title: '商务舱和头等舱预订',
				description:
					'提供专业服务，预订优质航空座位，确保商务或休闲旅行的舒适、便利和个性化机上体验。'
			},
			privateJets: {
				title: '私人飞机包机',
				description:
					'提供灵活和保密的私人飞机包机服务，满足客户寻求效率、隐私和定制旅行解决方案的需求。'
			}
		},
		about: {
			title: '关于途视光',
	...
	en: {
		...
		services: {
			...
			customTours: {
				...
				description:
					"Tailored personalized itineraries that combine cultural immersion, scenic exploration, and exclusive activities, ensuring every journey reflects the client's personal style and interests."
			},
			luxuryHotels: {
				title: 'Luxury Hotel Bookings',
				description:
					'Secure accommodations at luxury resorts and five-star hotels worldwide, offering premium facilities, exclusive benefits, and seamless booking experiences.'
			},
			premiumFlights: {
				title: 'Business & First Class Bookings',
				description:
					'Professional service for booking premium airline seats, ensuring comfort, convenience, and personalized in-flight experiences for business or leisure travel.'
			},
			privateJets: {
				title: 'Private Jet Charters',
				description:
					"Flexible and confidential private jet charter services, meeting clients' needs for efficiency, privacy, and customized travel solutions for both short and long-haul journeys."
			}
		},
		about: {
			title: 'About Waytime',
